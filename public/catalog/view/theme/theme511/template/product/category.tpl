		...
		<div class="product-layout product-list col-xs-12">
		  <div class="product-thumb">
			...
			<div>
			  <div class="caption">
				...
				<div class="description"><?php echo mb_substr($product['description'],0,73,'UTF-8').'...';?></div>
          ...
          <?php include $_SERVER['DOCUMENT_ROOT'] . '/catalog/view/theme/theme511/parcelamento.php'; ?>
				...
				<div class="cart-button">
					<button class="btn btn-add" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart hidden-md"></i> <span class="hidden-sm"><?php echo $button_cart; ?></span></button>
